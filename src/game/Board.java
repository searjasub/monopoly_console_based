...
public class Board {
	...
	public void initCards() {
		chance.add(new Card("\t\tChance\n", "\tGET OUT OF JAIL FREE\nThis card may be kept until needed or traded.", CardType.CHANCE, CardCategory.JAIL_FREE,1));
		communityChest.add(new Card("\t\tCommunity Chest\n", "\tGET OUT OF JAIL FREE\nThis card may be kept until needed or traded.", CardType.COMMUNITY_CHEST, CardCategory.JAIL_FREE,2));
		communityChest.add(new Card("\t\tCommunity Chest\n", "\tAdvance to GO. (Collect $200)", CardType.COMMUNITY_CHEST, CardCategory.MOVEMENT,3));
		chance.add(new Card("\t\tChance\n", "\tGo back three spaces.", CardType.CHANCE, CardCategory.MOVEMENT,4));
		chance.add(new Card("\t\t\tChance\n", "\t\tADVANCE TO THE NEAREST RAILROAD.\n\tIf UNOWNED, you may buy it from the bank.\n If OWNED, pay owner twice the rental to which they are otherwise entitled.", CardType.CHANCE, CardCategory.MOVEMENT,5));
		chance.add(new Card("\t\t\tChance\n", "\t\tADVANCE TO THE NEAREST UTILITY.\n \tIf UNOWNED, you may buy it from the bank.\n If OWNED, throw dice and pay owner ten times the amount thrown.", CardType.CHANCE, CardCategory.MOVEMENT,6));
		chance.add(new Card("\t\tChance\n", "\t\tADVANCE TO THE NEAREST RAILROAD.\n \tIf UNOWNED, you may buy it from the bank.\n If OWNED, pay owner twice the rental to which they are otherwise entitled.", CardType.CHANCE, CardCategory.MOVEMENT,7));
		chance.add(new Card("\tChance\n", "\tAdvance to GO. (Collect $200)", CardType.CHANCE, CardCategory.MOVEMENT,8));
		chance.add(new Card("\tChance\n", "Advance to Illinois Avenue.\nIf you pass GO, collect $200.", CardType.CHANCE, CardCategory.MOVEMENT,9));
		chance.add(new Card("\tChance\n", "Take a trip to Reading Railroad.\nIf you pass GO, collect $200.", CardType.CHANCE, CardCategory.MOVEMENT,10));
		chance.add(new Card("\tChance\n", "Advance to St. Charles Place.\nIf you pass GO, collect $200.", CardType.CHANCE, CardCategory.MOVEMENT,11));
		chance.add(new Card("\t\t  Chance\n", "\t\tGO TO JAIL.\nGO DIRECTLY TO JAIL, DO NOT PASS GO, DO NOT COLLECT $200.", CardType.CHANCE, CardCategory.MOVEMENT,12));
		communityChest.add(new Card("\t\tCommunity Chest\n", "\t\t  GO TO JAIL.\nGO DIRECTLY TO JAIL, DO NOT PASS GO, DO NOT COLLECT $200.", CardType.COMMUNITY_CHEST,CardCategory.MOVEMENT,13));
		chance.add(new Card("\tChance\n", "Advance to Boardwalk.", CardType.CHANCE, CardCategory.MOVEMENT,14));
		chance.add(new Card("\tChance\n", "  Speeding fine $15.", CardType.CHANCE, CardCategory.PAY_MONEY, 15, 15));
		communityChest.add(new Card("\t   Community Chest\n", "\tDoctor's fees. Pay $50.", CardType.COMMUNITY_CHEST, CardCategory.PAY_MONEY, 50, 16));
		communityChest.add(new Card("\t  Community Chest\n", "\tSchool fees. Pay $50.", CardType.COMMUNITY_CHEST, CardCategory.PAY_MONEY, 50,17));
		communityChest.add(new Card("\t   Community Chest\n", "\tHospital fees. Pay $100.", CardType.COMMUNITY_CHEST, CardCategory.PAY_MONEY, 100,18));
		communityChest.add(new Card("\t    Community Chest\n", "    You are assessed for street repairs: \nPay $40 per house and $115 per hotel you own.", CardType.COMMUNITY_CHEST, CardCategory.PAY_BUILDING_TAX,19));
		chance.add(new Card("\t\tChance\n", "   Make general repairs on all your property: \nFor each house pay $25, for each hotel pay $100.", CardType.CHANCE, CardCategory.PAY_BUILDING_TAX,20));
		communityChest.add(new Card("\t\tCommunity Chest\n", "It is your birthday. Collect $10 from every player.", CardType.COMMUNITY_CHEST, CardCategory.PAY_OR_RECEIVE_PLAYERS,21));
		chance.add(new Card("     Chance\n", "You have been elected chairman of the board.\n \tPay each player $50.",CardType.CHANCE, CardCategory.PAY_OR_RECEIVE_PLAYERS,22));
		chance.add(new Card("\t\tChance\n", "Your building loan matures. Collect $150.", CardType.CHANCE, CardCategory.RECEIVE_MONEY, 150,23));
		chance.add(new Card("\t  Chance\n", "Bank pays you dividend of $50.", CardType.CHANCE, CardCategory.RECEIVE_MONEY, 50,24));
		communityChest.add(new Card("\t  Community Chest\n", "Bank error in your favor. Collect $200.", CardType.COMMUNITY_CHEST, CardCategory.RECEIVE_MONEY, 200,25));
